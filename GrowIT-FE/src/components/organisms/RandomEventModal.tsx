      ...
      >
        ...
        <div className="relative pointer-events-auto">
          {isLoading ? (
            /* 신문 로딩 스타일 */
            <div 
              className="shadow-2xl relative bg-white border-4 border-gray-800 w-1/2 min-w-96 mx-auto pointer-events-auto"
              style={{ 
                minHeight: '200px'
              }}
            >
            ...
            event && (
              /* 신문 스타일 이벤트 */
              <div 
                className="shadow-2xl relative w-3/4 min-w-96 mx-auto"
                style={{ 
